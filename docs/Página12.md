...
![](img/AbaContasForaDoPrazo.png)<br>
*Figura 70 - Aba "Contas Fora do Prazo".* <br><br>

<p style="text-align: justify;"> Esta aba especifica as contas que estão fora do intervalo deferido pelo Judiciário.</p>

![](img/ContasForaDoPrazo.png)<br>
*Figura 71 - Contas fora do prazo.* <br>

## Descartar contas 
É possível descartar as contas fora do prazo uma por uma ou selecionando todas as contas de uma vez só (Figura 72):

![](img/DescartarContasForaDoPrazo.png)<br>
*Figura 72 - Descartar contas fora do prazo.* <br>
