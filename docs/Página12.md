...
![Aba "Atendimentos Fora do Período"](img/ContasForaDoPrazo.png)<br>
*Figura 63 - Contas fora do prazo.* <br>

## Descartar contas 
É possível descartar as contas fora do prazo uma por uma ou selecionando todas as contas de uma vez só (Figura x):

![Página2](img/DescartarContasForaDoPrazo.png)<br>
*Figura x - Descartar contas fora do prazo.* <br>
