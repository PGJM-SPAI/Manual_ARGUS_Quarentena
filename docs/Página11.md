...
![Aba "Atendimentos Fora do Período"](img/AtendimentosForaDoPeríodo.png)<br>
...
<p style="text-align: justify;">Ao clicar em descartar, uma janela será aberta com um campo de justificativa da exclusão - o registro é relevante quando o quarentenista, após algum tempo, quiser recuperar os dados ou saber a causa do descarte (Figura x). </p>

![Página2](img/JustificarDescarteAtendimento.png)<br>
*Figura x - Justificar descarte de atendimento.* <br><br>