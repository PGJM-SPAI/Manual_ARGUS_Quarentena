# Atendimentos Fora do Período

![](img/AbaAtendimentosForaDoPeríodo.png)<br>
*Figura 66 - Aba "Atendimentos Fora do Período".* <br><br>
...
![](img/AtendimentosForaDoPeríodo.png)<br>
*Figura 67 - Atendimentos Fora do Período.* <br>

## Descartar atendimentos
<p style="text-align: justify;">É possível descartar os atendimentos fora do período um por um ou selecionando todos os atendimentos de uma vez só (Figura 68): </p>

![](img/DescartarAtendimentoForaDoPeriodo.png)<br>
*Figura 68 - Descartar atendimentos fora do período.* <br>
...
<p style="text-align: justify;">Ao clicar em descartar, uma janela será aberta com um campo de justificativa da exclusão - o registro é relevante quando o quarentenista, após algum tempo, quiser recuperar os dados ou saber a causa do descarte (Figura 69). </p>

![](img/JustificarDescarteAtendimento.png)<br>
*Figura 69 - Justificar descarte de atendimento.* <br><br>